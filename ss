...
$loc_text = esc_attr__( 'Select Location', 'test' );
$cat_text = esc_attr__( 'Select Category', 'test' );
$typ_text = esc_attr__( 'Select Type', 'test' );
...
?>
<form action="<?php echo esc_url( Functions::get_filter_form_url() ); ?>" class="form-vertical rtcl-widget-search-form rtcl-search-inline-form test-listing-search-form rtin-style-<?php echo esc_attr( $style );?> rtin-count-<?php echo esc_attr( $count );?>">
	<div class="row">
			...
			<div class="<?php echo esc_attr( $loc_class );?>">
				<div class="form-group">
					<?php if ( $style == 'suggestion' ): ?>
						<div class="rtcl-search-input-button test-search-style-2 rtin-location">
			...
			<div class="<?php echo esc_attr( $cat_class );?>">
				<div class="form-group">
					<?php if ( $style == 'suggestion' || $style == 'standard' ): ?>
						<div class="rtcl-search-input-button test-search-style-2 rtin-category">
							<?php
							wp_dropdown_categories( array(
					...
					<?php elseif ( $style == 'dependency' ): ?>
						<div class="rtcl-search-input-button test-search-style-2 test-search-dependency rtin-category">
							<?php
							Functions::dropdown_terms( array(
								'show_option_none'  => $cat_text,
								'option_none_value' => - 1,
			...
			<div class="<?php echo esc_attr( $typ_class );?>">
				<div class="form-group">
					<div class="rtcl-search-input-button rtcl-search-input-type">
						...
						?>
						<div class="dropdown test-listing-search-dropdown">
							<button class="btn dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php esc_html_e( 'Select Type', 'test' ); ?></button>
			...
			<div class="<?php echo esc_attr( $key_class );?>">
				<div class="form-group">
					<div class="rtcl-search-input-button rtin-keyword">
						<input type="text" data-type="listing" name="q" class="rtcl-autocomplete" placeholder="<?php esc_html_e('Enter Keyword here ...', 'test'); ?>" value="<?php if (isset($_GET['q'])) {echo esc_attr($_GET['q']);} ?>" />
					</div>
				</div>
			</div>
		<?php endif; ?>
		...
		<div class="<?php echo esc_attr( $btn_class );?> rtin-btn-holder">
			<button type="submit" class="rtin-search-btn rdtheme-button-1"><i class="fa fa-search" aria-hidden="true"></i><?php esc_html_e( 'Search', 'test' );?></button>
		</div>
	</div>
</form>
